...
/* in file xsh_sendmsg.c */
shellcmd xsh_netfutures	(int, char *[]);

/* in file xsh_sendmsg.c */
shellcmd xsh_sendmsg	(int, char *[]);

/* in file xsh_sendmsg.c */
shellcmd xsh_arpstale	(int, char *[]);

/* in file xsh_hello.c */
shellcmd xsh_hello	(int, char *[]);

/* in file xsh_mem.c */
shellcmd xsh_mem	(int, char *[]);

/* in file xsh_memtest.c */
shellcmd xsh_memtest	(int, char *[]);
